...
The class diagram depicts 17 classes and 3 functions, organized into the following 5 groups. With this as a framework, we can forego the class specifications and start coding. Our agenda will be:         
