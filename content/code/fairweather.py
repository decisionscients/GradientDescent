...
elev_contour = gpd.read_file('./content/figures/VECTOR_Mount_Fairweather_D-6_NW_AK_7_5_Min_Shape/Shape/Elev_Contour.shp')
...
#%%
# Plot shape records
ec = shp.Reader('./content/figures/VECTOR_Mount_Fairweather_D-6_NW_AK_7_5_Min_Shape/Shape/Elev_Contour.shp')
...
for line in elev_contour['geometry']:
    gpd.plotting.plot_multilinestring(ax, line, color='yellow', linewidth=3)
mplleaflet.display(fig=f, crs=elev_contour.crs.crs)