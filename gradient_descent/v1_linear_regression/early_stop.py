...
class EarlyStopImprovement(EarlyStop):
    ...
    monitor : str, optional (default='val_score')
        Specifies which statistic to monitor for performance evaluation purposes.
    ...
    def _validate(self):
        if self.monitor not in ['train_cost', 'train_score', 'val_cost', 'val_score']:
            ...
            raise ValueError("'score' has been selected for evaluation; however"
                             ...
                             "Either the monitor parameter in the EarlyStop class to "
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        # Evaluate performance
            ...
            if self.iter_no_improvement == self.patience:
                self.converged = True            
